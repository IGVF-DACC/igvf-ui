...
describe("Test the formatPropertyName utility function", () => {
  it("Should convert a string to formatPropertyName case", () => {
    expect(formatPropertyName("Property_Name")).toBe("Property Name");
    expect(formatPropertyName("PRoperty_NamE")).toBe("Property Name");
    expect(formatPropertyName("property_name")).toBe("Property Name");
  });
});
