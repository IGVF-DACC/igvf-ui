...
const Icon = {
  ...
  RodentDonor: ({ className = null }) => (
    ...
    >
      <path
        d="M15,1.4H5L0,10l5,8.6h10l5-8.6L15,1.4z M13.6,13.8c-2.7,0-7.9,0-8,0c0,0,0,0,0,0c-0.8,0-1.4-0.3-1.8-1
	c-0.6-0.8-0.6-2.1-0.1-3.2c0.4-0.8,1.2-1.4,2-2c1.5-1.2,2.4-2,1.7-3.2C7.2,4.2,7.3,3.9,7.5,3.7c0.2-0.1,0.5-0.1,0.7,0.2
	c1.2,2.1-0.6,3.5-2,4.5C5.5,9,4.8,9.5,4.5,10.1c-0.3,0.7-0.3,1.6,0.1,2.1c0.2,0.4,0.6,0.5,1.1,0.5C6.1,10,8.5,8,11.3,8c0,0,0,0,0,0
	c0,0.2-0.1,0.5-0.1,0.8c0,0.2,0.2,0.3,0.3,0.3c0.2,0,0.3-0.2,0.3-0.3C12,7.3,12.8,6,13.7,6c0.9,0,1.6,1.1,1.7,2.5
	c0,0.4-0.1,0.8-0.2,1.1c0.7,0.8,1.2,1.8,1.9,3.2C17.1,12.8,16.3,13.8,13.6,13.8z"
      />
    </svg>
  ),
