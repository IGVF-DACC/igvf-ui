...
/**
 * Height of the quality metric trigger rectangle within a file node.
 */
...
/**
 * Display a list of quality metrics for a file into the currently rendering file node.
...
function Graph({
   ...
   * `selectedQualityMetrics` state, the modal showing the quality metrics will be displayed in a modal.
