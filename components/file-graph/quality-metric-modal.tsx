...
/**
 * Type guard to check if a quality metric is a MpraQualityMetric.
 * @param qualityMetric - Quality metric object to check
 * @returns True if the quality metric is a MpraQualityMetric
 */
        ...
        <div className="flex max-h-[80svh] flex-wrap gap-2 overflow-y-auto @container/qualityMetric-metric-modal md:max-h-[calc(80dvh-7rem)]">
          {qualityMetrics.map((metric) => {
            ...
            return (
              <DataPanel
                key={metric["@id"]}
                className="only-child:w-full w-full rounded-md lg/qualityMetric-metric-modal:w-[calc(50%-0.25rem)]"
              >
