...
const staticData: DataTableFormat = [
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Jason Ernst (jason.ernst@ucla.edu)" },
    ],
  },
  {
    id: "2",
    cells: [
      ...
      { id: "G", content: "Jesse Engreitz (engreitz@stanford.edu)" },
    ],
  },
  {
    id: "3",
    cells: [
      ...
      { id: "F", content: "Weeks et al. medRxiv 2021" },
      { id: "G", content: "Hilary Finucane, Jesse Engreitz" },
    ],
  },
  {
    id: "4",
    cells: [
      ...
      { id: "F", content: "Nasser et al. Nature 2021" },
      { id: "G", content: "Jesse Engreitz (engreitz@stanford.edu)" },
    ],
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Anshul Kundaje (akundaje@stanford.edu)" },
    ],
  },
  {
    id: "6",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Zhiping Weng (zhipingweng@gmail.com)" },
    ],
  },
  {
    id: "10",
    cells: [
      ...
      { id: "G", content: "Jill Moore (Jill.Moore@umassmed.edu)" },
    ],
  },
  {
    id: "11",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "B", content: "Non-/coding variant effects/prioritization" },
      { id: "C", content: "CADD" },
      ...
      { id: "G", content: "Martin Kircher (martin.kircher@bih-charite.de)" },
    ],
  },
  {
    id: "13",
    cells: [
      ...
      { id: "F", content: "Unpublished" },
      { id: "G", content: "Jason Buenrostro" },
    ],
  },
  {
    id: "14",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Soumya Raychaudhuri (soumya@broadinstitute.org)" },
    ],
  },
  {
    id: "16",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Alan Boyle (apboyle@umich.edu)" },
    ],
  },
  {
    id: "18",
    cells: [
      { id: "A", content: "Target gene prediction (variant)" },
      { id: "B", content: "" },
      { id: "C", content: "cS2G" },
      ...
      { id: "G", content: "Steven Gazal (gazal@usc.edu)" },
    ],
  },
  {
    id: "19",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Brunilda Balliu (bballiu@ucla.edu" },
    ],
  },
  {
    id: "21",
    cells: [
      ...
      { id: "G", content: "Xihong Lin (xlin@hsph.harvard.edu)" },
    ],
  },
  {
    id: "22",
  ...
  },
  {
    ...
    cells: [
      ...
      },
      {
        ...
        content: (
          <>
            <div>Still in early development:</div>
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "G", content: "Predrag Radivojac (predrag@northeastern.edu)" },
    ],
  },
  {
    id: "26",
  ...
  },
  {
    ...
    cells: [
      ...
      { id: "F", content: "Unpublished, early development" },
      { id: "G", content: "Mark Craven (craven@biostat.wisc.edu)" },
    ],
  },
];
