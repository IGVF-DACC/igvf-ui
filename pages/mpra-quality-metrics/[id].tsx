...
export default function MpraQualityMetric({
  qualityMetric,
  qualityMetricOf,
  isJson,
}: {
...
export async function getServerSideProps({ params, req, query }) {
  ...
  const item = (
    await request.getObject(`/mpra-quality-metrics/${params.id}/`)
  ).union() as MpraQualityMetricObject;
